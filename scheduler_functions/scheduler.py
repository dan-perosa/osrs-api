...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=54)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=53)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=52)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=51)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=50)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=49)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=48)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=47)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=46)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=45)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=44)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=43)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=42)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=41)) , minutes=5),
)
...
scheduler.add_job(
    ...
    trigger=IntervalTrigger(start_date=(datetime.now() - timedelta(minutes=4, seconds=40)) , minutes=5),
)
